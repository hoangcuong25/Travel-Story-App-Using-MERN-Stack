...
const DateSelector = ({ date, setDate }) => {
    ...
    return (
        <div>
            <button className='inline-flex items-center gap-2 text-[13px] font-medium text-sky-600
            ...
            {openDatePicker && (
                <div className='overflow-y-scroll p-5 bg-sky-50/80 rounded-lg relative pt-9'>
                    <button
                        className='w-10 h-10 flex items-center justify-center bg-sky-100 hover:bg-sky-100 absolute top-2 right-2'
